                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                     <div class="panel-heading">
                                        <h1 class="panel-title" style="color: #337ab7; font-size: 25px;">MOTIVO DE LA CONSULTA: </h1>
                                    </div>
                                </div>

                            
                                  <div class="col-xs-12 col-md-12" style="text-align: center;">
                                      <h1 class="panel-title" style="color: #337ab7; font-size: 18px;">ESPECIFICAR: </h1>  
                                  </div>

                                  <div class="col-xs-12 col-md-12" style="padding-top: 20PX;">
                                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" onKeyUp="this.value=this.value.toUpperCase();"></textarea>                                    
                                  </div>

                                    <div class="col-xs-12 col-md-3 pull-right" style="padding-top: 20PX;">
                                        <button class="btn btn-primary btn-block" onclick="guardarMot()">
