...
*/
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvas18");
	...
	var clearBtn = document.getElementById("sig-clearBtn18");
	var submitBtn = document.getElementById("sig_submitBtn18");
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        //$( '#imagen' ).show();
					        ...
					        var val = location.href.split("index=")[1];
							$('#firma_paciente3').attr("src",'firmas/'+val+"_firma.png");

							$("#firma3").css("display", "none");
							$("#firma_paciente3").css("display", "block");
							$("#generar_facial3").css("display", "block");
							

							$("#commentPictureModal21").modal('hide');
