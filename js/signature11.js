...
*/
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvas11");
	...
	var clearBtn = document.getElementById("sig-clearBtn11");
	var submitBtn = document.getElementById("sig_submitBtn11");
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        //$( '#imagen' ).show();
					        ...
					        var val = location.href.split("index=")[1];
							$('#firma_familiar').attr("src",'firmas/'+val+"_firmaF.png");

							$("#firma2").css("display", "none");
							$("#firma_familiar").css("display", "block");
							$("#generar_facial").css("display", "block");
							

							$("#commentPictureModal12").modal('hide');
