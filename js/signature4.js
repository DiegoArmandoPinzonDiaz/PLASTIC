...
*/
	...
	var clearBtn = document.getElementById("sig-clearBtn4");
	var submitBtn = document.getElementById("sig_submitBtn4");
...
//AQUIIII
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        var val = location.href.split("index=")[1];
							$('#firma_familiar_nota').attr("src",'firmas/'+val+"_firmaF.png");

							$("#firma_nota2").css("display", "none");
							$("#firma_familiar_nota").css("display", "block");
							$("#generar_nota").css("display", "block");


				        $("#commentPictureModal4").modal('hide');
				        $("#NOTA_ALTA").modal('show');
