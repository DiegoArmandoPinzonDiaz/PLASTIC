...
*/
	...
	var submitBtn = document.getElementById("sig_submitBtn3");
...
//AQUIIII
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        var val = location.href.split("index=")[1];
							$('#firma_paciente_nota').attr("src",'firmas/'+val+"_firma.png");

							$("#firma_nota1").css("display", "none");
							$("#firma_paciente_nota").css("display", "block");
							//$("#generar_facial").css("display", "block");


				        $("#commentPictureModal3").modal('hide');
		...
		//generarPDF2();
		//$("#commentPictureModal4").modal('show');
