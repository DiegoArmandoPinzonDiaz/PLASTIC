...
*/
	...
	var clearBtn = document.getElementById("sig-clearBtn5");
	var submitBtn = document.getElementById("sig_submitBtn5");
...
//AQUIIII
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        $("#commentPictureModal5").modal('hide');
						$("#CARTA_CONSENTIMIENTO").modal('show');

						var val = location.href.split("index=")[1];
							$('#firma_consentimiento_paciente').attr("src",'firmas/'+val+"_firma.png");

							$("#firma_consentimiento1").css("display", "none");
							$("#firma_consentimiento_paciente").css("display", "block");
