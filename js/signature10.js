...
*/
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvas10");
	...
	var clearBtn = document.getElementById("sig-clearBtn10");
	var submitBtn = document.getElementById("sig_submitBtn10");
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        //$( '#imagen' ).show();
					        ...
					        var val = location.href.split("index=")[1];
							$('#firma_paciente').attr("src",'firmas/'+val+"_firma.png");

							$("#firma1").css("display", "none");
							$("#firma_paciente").css("display", "block");
							$("#generar_facial").css("display", "block");
							

							$("#commentPictureModal11").modal('hide');
