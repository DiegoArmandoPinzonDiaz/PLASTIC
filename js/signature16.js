...
*/
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvas16");
	...
	var clearBtn = document.getElementById("sig-clearBtn16");
	var submitBtn = document.getElementById("sig_submitBtn16");
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        //$( '#imagen' ).show();
					        ...
					        var val = location.href.split("index=")[1];
							$('#firma_paciente2').attr("src",'firmas/'+val+"_firma.png");

							$("#firma2").css("display", "none");
							$("#firma_paciente2").css("display", "block");
							$("#generar_facial2").css("display", "block");
							

							$("#commentPictureModal18").modal('hide');
