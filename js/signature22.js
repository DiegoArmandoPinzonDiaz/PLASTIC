...
*/
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvas22");
	...
	var clearBtn = document.getElementById("sig-clearBtn22");
	var submitBtn = document.getElementById("sig_submitBtn22");
		...
		var val = location.href.split("index=")[1];
		 			...
		 			$.ajax({
				        ...
				        //$( '#imagen' ).show();
					        ...
					        var val = location.href.split("index=")[1];
							$('#ind_pre_firma_paciente').attr("src",'firmas/'+val+"_firma.png");

							$("#firma_ind_pre").css("display", "none");
							$("#pdf_ind_pre").css("display", "block");
							$("#ind_pre_firma_paciente").css("display", "block");
							

							$("#commentPictureModal22").modal('hide');
