<?php 
	...
	//function generarPDF1()
      //{                                      
                    ...
                    $val8=$_GET['padecimiento'];
                    $val9=$_GET['tratamiento'];                   
                    $val10=$_GET['evolucion'];
...
if($val19==1){
         ...
         $html=$html.'
           ...
           <table class="table1" style="margin-top: -2px; font-size:10px; " >
            ...
            <table class="table1" style="margin-top: -2px; font-size:10x; " >
                           <tr> 
         ...
         $html=$html.'
            ...
            <table class="table1" style="margin-top: -2px; font-size:10px; " >
                           <tr> 
                            ...
                            <td style=" width:519px; text-align:left; vertical-align:text-top; font-size:10x;" class="td2" >
                           ...
                           ';
                            ...
                            $html=$html.'       <div id="texto_firma" style="float:left;  position: absolute; bottom: 75;">   
