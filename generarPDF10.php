...
<BR><BR><BR><BR><BR><BR>
                                    ...
                                    <div class="row" style="text-align: justify; font-family: Georgia;  <!--background-image: url(imagenes/fondo.png); background-position: center; background-repeat:no-repeat; z-index: 1;-->  ">
                                              ...
                                              <table class="table1 " >
                                                ...
                                                <table class="table1" style="margin-top: -2px; " >
                                                    ...
                                                    <tr> 
                                                      <td style=" width:753px; text-align:left;" class="td2" >
                                                             ...
                                                             <b>MOTIVO DE LA CONSULTA:</b> &nbsp; &nbsp;  '.$val10.'                                                           

                                                      </td>
                                                    </tr> 
                                                    <!--<tr> 
                                                      <td style=" width:753px; height:60px; text-align:justify; vertical-align:text-top; text-align:left;" class="td2" >

                                                             <b>PATOLOG&Iacute;AS PREVIAS:</b> &nbsp; &nbsp;  '.$val11.'                                                           

                                                      </td>
                                                    </tr>--> 
                                                    <tr> 
                                                      <td style=" width:753px; text-align:justify; vertical-align:text-top; text-align:left; font-size:9px;" class="td2" >
                                                ...
                                                <table class="table " style="margin-top: -2px; ">
                                                    <tr> 
                                                      <td style=" width:753px; text-align:justify; vertical-align:text-top; font-size:9px;" class="td2" >
                                                    ...
                                                    <!--<tr> 
                                                      <td style=" width:753px; height:60px;  text-align:justify;" class="td2" >

                                                             <b>LABORATORIO Y GABINETE:</b> &nbsp; &nbsp; '.$val23.'                                                          
...
if($val31==1){
         ...
         $html=$html.'
           ...
           <table class="table1" style="margin-top: -2px; font-size:10px; " >
                           <tr> 
                            <td style=" width:753px; text-align:left; vertical-align:text-top; font-size:9px;" class="td2" >
