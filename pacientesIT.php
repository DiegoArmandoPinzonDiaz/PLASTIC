                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                     <div class="panel-heading">
                                        <h1 class="panel-title" style="color: #337ab7; font-size: 25px;">INDICACI&Oacute;N TERAP&Eacute;UTICA: </h1>
                                    </div>
                                </div>

                                    <textarea rows="10" id="indicacionTer" type="text" class="form-control" value="" onblur="this.value=this.value.toUpperCase();"></textarea>


                                    <div class="col-xs-12 col-md-3 pull-right" style="padding-top: 20PX;">
                                        <button class="btn btn-primary btn-block" onclick="guardarIT()">
