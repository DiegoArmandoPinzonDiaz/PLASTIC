                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                     <div class="panel-heading">
                                        <h1 class="panel-title" style="color: #337ab7; font-size: 25px;">TRATAMIENTOS ESTÉTICOS PREVIOS: </h1>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-xs-12 col-md-12" >
                                  ...
                                  <div class="col-xs-12 col-md-12" >
                                    ...
                                    <div class="col-xs-12 col-md-3 pull-right" style="padding-top: 20PX;">
                                        <button type="submit" class="btn btn-primary btn-block" onclick="guardarTraFac()">
