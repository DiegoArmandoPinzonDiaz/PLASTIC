<?php
     ...
     if(isset($_POST["texto"]))
      {
                  ...
                  if(mysqli_connect_errno()){
                        echo 'No se pudo conectar a la base de datos : '.mysqli_connect_error();
                          ...
                          $sql = mysqli_query($con, "SELECT * FROM GABINETE WHERE ID_GABINETE = '".$val."' ");
  ...
  //echo $nom;
                                            $arrayPHP=array("ID_GABINETE"=>$ID_GABINETE, "FECHA_GABINETE"=>$FECHA_GABINETE, "ESTUDIOS_GABINETE"=>$ESTUDIOS_GABINETE, "RESULTADOS_GABINETE"=>$RESULTADOS_GABINETE); 
