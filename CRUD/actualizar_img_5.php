                        ...
                        if(mysqli_connect_errno()){
                              ...
                              if($contar > 0){ 
                                          ...
                                          if($imagen6 != ""){  $ruta = "../imgPacientes/".$imagen6;  unlink($ruta);  }                                   
                                                ...
                                                $sql = mysqli_query($con, "UPDATE SEGUIMIENTO_FOTOGRAFICO SET FOTO5_1 = '".$val2."', FOTO5_2 = '".$val3."', FOTO5_3 = '".$val4."', FOTO5_4 = '".$val5."', FOTO5_5 = '".$val6."', DESCRIPCION_5 = '".$val7."', FECHA_5 = '".$val8."', FOTO5_6 = '".$val9."'  WHERE FOLIO = '".$val."' "); 
                                          ...
                                          $sql = mysqli_query($con, "INSERT INTO SEGUIMIENTO_FOTOGRAFICO (FOLIO, FOTO5_1, FOTO5_2, FOTO5_3, FOTO5_4, FOTO5_5, DESCRIPCION_5, FECHA_5, FOTO5_6 ) VALUES ('$val','$val2','$val3','$val4','$val5','$val6','$val7','$val8','$val9' ) "); 
